  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<Surah>>(
      ...
      builder: (context, snapshot) {
        ...
        // Filter Surahs based on the search query in Arabic
        List<Surah> filteredSurahs = snapshot.data!
            .where((surah) => surah.nama.toLowerCase().contains(searchQuery.toLowerCase()) || 
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(
                      surah.nama, // استخدم الاسم العربي هنا
                      style: const TextStyle(color: Colors.white),
                    ),
